...
//kernel --> GPU
__global__ void kernelDosParcas(int n, int maior, int menor, int* array_rand, int* array_result){
    int i = threadIdx.x;
    while (i < n) {
...
int main(){
    ...
    kernelDosParcas <<<6, 1000>>>(n, maior, menor, d_array_rand, d_array_result);
